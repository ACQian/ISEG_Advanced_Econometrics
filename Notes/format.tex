...
\titleformat{\section}[block]
  {\centering\bfseries\color{keydark}\fontsize{15pt}{15pt}\selectfont}
  {\thesection}{0.6em}{}
...
\fancyfoot[L]{\textcolor{brand}{Amy QIAN}} %\seriesnum}
...
\newcommand{\ChapterHeading}{%
  \vspace*{0.6cm}
  {\centering
    {\fontsize{17pt}{17pt}\selectfont\bfseries\color{keydark}
